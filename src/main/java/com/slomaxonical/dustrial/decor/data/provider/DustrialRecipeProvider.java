...
public class DustrialRecipeProvider extends FabricRecipeProvider {
    ...
    public DustrialRecipeProvider(FabricDataOutput output) {
        super(output);
    }
    ...
    public void generate(Consumer<RecipeJsonProvider> exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ANCHOR).input('$',LARGE_CHAIN).input('#', Items.IRON_INGOT).pattern(" $ ").pattern(" # ").pattern("# #").criterion("has_large_chain",conditionsFromItem(DustrialBlocks.LARGE_CHAIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, HOOK).input('$',LARGE_CHAIN).input('#', Items.IRON_INGOT).pattern(" $").pattern(" #").pattern("# ").criterion("has_large_chain",conditionsFromItem(DustrialBlocks.LARGE_CHAIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BARBED_CHAIN_LINK_FENCE,16).input('$', Items.IRON_NUGGET).input('#', Blocks.CHAIN).pattern("#$#").pattern("$#$").pattern("#$#").criterion("has_chain",conditionsFromItem(Items.CHAIN)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, BARBED_IRON_BARS,16).input('$', Items.IRON_NUGGET).input('#', Items.IRON_INGOT).pattern("$$$").pattern("###").pattern("###").criterion("has_chain",conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.MISC, RAINBOW_NEON_LIGHT,8).input(RED_NEON_LIGHT).input(ORANGE_NEON_LIGHT).input(YELLOW_NEON_LIGHT).input(GREEN_NEON_LIGHT).input(CYAN_NEON_LIGHT).input(BLUE_NEON_LIGHT).input(PURPLE_NEON_LIGHT).input(PINK_NEON_LIGHT).criterion("has_neon", conditionsFromTag(DustrialTags.NEON_BLOCKS)).offerTo(exporter);

        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC,DustrialBlocks.BOLTED_INDUSTRIAL_IRON_BLOCK, DustrialBlocks.INDUSTRIAL_IRON_BLOCK);
        ...
        //cardboard
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CARDBOARD, 2).input('#', Items.PAPER).pattern("##").pattern("##").criterion("has_paper",conditionsFromItem(Items.PAPER)).offerTo(exporter);
        ...
        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC,FOLDED_CARDBOARD,SMOOTH_CARDBOARD);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CARDBOARD_HELMET).input('#', DustrialItems.CARDBOARD).pattern("###").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CARDBOARD_CHESTPLATE).input('#', DustrialItems.CARDBOARD).pattern("# #").pattern("###").pattern("###").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CARDBOARD_LEGGINGS).input('#', DustrialItems.CARDBOARD).pattern("###").pattern("# #").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CARDBOARD_BOOTS).input('#', DustrialItems.CARDBOARD).pattern("# #").pattern("# #").criterion("has_cardboard",conditionsFromItem(DustrialItems.CARDBOARD)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialBlocks.CARDBOARD_SCRAP, 8).input('#', DustrialTags.CARDBOARD_BLOCKS).pattern("###").pattern("# #").pattern("###").criterion("has_cardboard",conditionsFromTag(DustrialTags.CARDBOARD_BLOCKS)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialBlocks.CAST_IRON_BALUSTRADE, 16).input('#', DustrialItems.CAST_IRON_BILLET).pattern("###").pattern("###").criterion(hasItem(DustrialItems.CAST_IRON_BILLET),conditionsFromItem(DustrialItems.CAST_IRON_BILLET)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, DustrialItems.CAST_IRON_BILLET, 4).input('#', Items.IRON_INGOT).input('$',Items.COAL).pattern("#$").pattern("$$").criterion(hasItem(Items.IRON_INGOT),conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        offerEmptyFrameRecipe(exporter,CAST_IRON_BLOCK, CAST_IRON_BILLET,12);
        offerPolishedStoneRecipe(exporter,RecipeCategory.MISC,CAST_IRON_BRICKS,CAST_IRON_BLOCK);
        ...
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC,Blocks.CHAIN, RecipeCategory.MISC,WRAPPED_CHAINS, "wrapped_chains",null,"chains_from_wrapped",null);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, CHAIN_LINK_FENCE, 16).input('#', Blocks.CHAIN).pattern("# #").pattern(" # ").pattern("# #").criterion("has_chain",conditionsFromItem(Blocks.CHAIN)).offerTo(exporter);
        offerDetailedTrapDoorRecipe(exporter, CHAIN_TRAPDOOR, CHAIN_LINK_FENCE, Items.IRON_INGOT);
        //cinder
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, CINDER_BLOCK, 4).input('#', DustrialTags.CONCRETE_POWDER).input('$',Items.COAL).pattern("#$").pattern("$#").criterion("has_concrete",conditionsFromTag(DustrialTags.CONCRETE_POWDER)).offerTo(exporter);
        offerPolishedStoneRecipe(exporter,RecipeCategory.MISC,POLISHED_CINDER_BLOCK, CINDER_BLOCK);
        offerPolishedStoneRecipe(exporter,RecipeCategory.MISC,CINDER_BRICKS, POLISHED_CINDER_BLOCK);
        ...
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, GOLD_CHAIN, RecipeCategory.MISC, WRAPPED_GOLD_CHAINS, "wrapped_gold_chains",null,"chains_from_gold_wrapped",null);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, INDUSTRIAL_IRON_BILLET, 4).input('#', Items.IRON_INGOT).input('$',Items.COAL).pattern("#$").pattern("$#").criterion("has_iron_ingot",conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, INDUSTRIAL_IRON_TRAPDOOR).input('#', INDUSTRIAL_IRON_BILLET).pattern("##").pattern("##").criterion("has_industrial_billet",conditionsFromItem(INDUSTRIAL_IRON_BILLET)).offerTo(exporter);

        offerBlasting(exporter, SHEETS,RecipeCategory.MISC, Items.IRON_INGOT,0.35F,100, "iron_ingot");
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, IRON_BAR_TRAPDOOR).input('#', Items.IRON_BARS).pattern("##").pattern("##").criterion("has_iron_bars",conditionsFromItem(Items.IRON_BARS)).offerTo(exporter);
        ...
        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC, MINI_PADDED_BLOCK, PADDED_BLOCK);
        offerSlabNStairsRecipes(exporter, MINI_PADDED_SLAB, MINI_PADDED_STAIRS, MINI_PADDED_BLOCK);
        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC, PADDED_BLOCK, Blocks.WHITE_WOOL);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, PADDED_BLOCK, 4).input('#', MINI_PADDED_BLOCK).pattern("##").pattern("##").criterion("has_mini_padded_blocks",conditionsFromItem(MINI_PADDED_BLOCK)).offerTo(exporter,new Identifier("padded_block_from_mini"));
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, PADDED_DOOR, 3).input('#', DustrialTags.PADDED_BLOCKS).input('$', INDUSTRIAL_IRON_BILLET).pattern("##").pattern("#$").pattern("##").criterion("has_padded", conditionsFromTag(DustrialTags.PADDED_BLOCKS)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, PADDED_TRAPDOOR).input('#', DustrialTags.PADDED_BLOCKS).input('$', INDUSTRIAL_IRON_BILLET).pattern("#$#").pattern("###").criterion("has_padded", conditionsFromTag(DustrialTags.PADDED_BLOCKS)).offerTo(exporter);

        offerFramedRecipe(exporter, REDSTONE_LANTERN, Items.REDSTONE_TORCH, Items.IRON_NUGGET , 1);
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, RUSTY_IRON_INGOT ,RecipeCategory.MISC,RUSTY_IRON_BLOCK, "rusty_iron_block",null, "rusty_ingots_from_block",null);
        offerReversibleCompactingRecipes(exporter, RecipeCategory.MISC, RUSTY_IRON_NUGGET ,RecipeCategory.MISC,RUSTY_IRON_INGOT, "rusty_iron_ingot_from_nugget",null, "rusty_nuggets_from_ingot",null);
        offerDetailedDoorRecipe(exporter, RUSTY_IRON_DOOR, RUSTY_IRON_INGOT, RUSTY_IRON_NUGGET);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, RUSTY_IRON_TRAPDOOR).input('#', RUSTY_IRON_INGOT).pattern("##").pattern("##").criterion("has_rusty_ingot",conditionsFromItem(RUSTY_IRON_INGOT)).offerTo(exporter);
        ...
        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC, RUSTY_SHEET_METAL_PANELING, RUSTY_SHEET_METAL_PLATING);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, RUSTY_SHEET_METAL_SIDING, 16).input('#', RUSTY_SHEET_METAL).pattern("# #").pattern("# #").pattern("# #").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, RUSTY_SHEET_METAL_TRAPDOOR).input('#', RUSTY_SHEET_METAL).pattern("##").pattern("##").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        //maybe should do that little X pttrn
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, RUSTY_SHEET_METAL_TREADING, 6).input('#', RUSTY_SHEET_METAL).input('$',Items.IRON_NUGGET).pattern("#$").pattern("$#").criterion("has_rusty_sheet",conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, RUSTY_SHEET_METAL_WALLING,16).input('#', RUSTY_SHEET_METAL).pattern("###").pattern("   ").pattern("###").criterion("has_rusty_sheet", conditionsFromItem(RUSTY_SHEET_METAL)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SHEET_METAL, 3).input('#', Items.IRON_INGOT).pattern("###").criterion("has_iron_ingot", conditionsFromItem(Items.IRON_INGOT)).offerTo(exporter);
        createDoorRecipe(SHEET_METAL_DOOR, Ingredient.ofItems(SHEET_METAL));
        offerPolishedStoneRecipe(exporter, RecipeCategory.MISC, SHEET_METAL_PANELING, SHEET_METAL_PLATING);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SHEET_METAL_SIDING, 16).input('#', SHEET_METAL).pattern("# #").pattern("# #").pattern("# #").criterion("has_metal_sheet", conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SHEET_METAL_TRAPDOOR).input('#', SHEET_METAL).pattern("##").pattern("##").criterion("has_sheet_metal",conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SHEET_METAL_TREADING, 6).input('#', SHEET_METAL).input('$',Items.IRON_NUGGET).pattern("#$").pattern("$#").criterion("has_sheet_metal",conditionsFromItem(SHEET_METAL)).offerTo(exporter);
        offerSlabNStairsRecipes(exporter, SHEET_METAL_TREADING_SLAB, SHEET_METAL_TREADING_STAIRS, SHEET_METAL_TREADING);
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, SHEET_METAL_WALLING,16).input('#', SHEET_METAL).pattern("###").pattern("   ").pattern("###").criterion("has_sheet_metal", conditionsFromItem(SHEET_METAL)).offerTo(exporter);
...
//    public static void offerShapedRecipe
    public static void offerDetailedDoorRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible base, ItemConvertible detail){
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output, 3).input('#', base).input('$', detail).pattern("##").pattern("#$").pattern("##").criterion(hasItem(base), conditionsFromItem(base)).offerTo(exporter);
    }
    public static void offerDetailedTrapDoorRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible base, ItemConvertible detail){
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output).input('#', base).input('$', detail).pattern("#$#").pattern("###").criterion(hasItem(base), conditionsFromItem(base)).offerTo(exporter);
    }
    public static void offerChainRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible input1, ItemConvertible input2, int count){
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output,count).input('#', input1).input('$', input2).pattern("#").pattern("$").pattern("#").criterion(hasItem(input1), conditionsFromItem(input1)).offerTo(exporter);
    }
    ...
    public static void offerLargeLanternRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible heart){
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output).input('#', Items.IRON_INGOT).input('$', heart).input('G', Items.GLOWSTONE).pattern("###").pattern("$G$").pattern("###").criterion(hasItem(heart), conditionsFromItem(heart)).offerTo(exporter);
    }
    public static void offerNeonLightRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible surround) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output, 8).input('#', surround).input('$', Blocks.GLOWSTONE).pattern("###").pattern("#$#").pattern("###").group("neon_light").criterion("has_glowstone", conditionsFromItem(Blocks.GLOWSTONE)).offerTo(exporter);
    }
    public static void offerNeonLightRecipe(Consumer<RecipeJsonProvider> exporter, ItemConvertible output, ItemConvertible surround, String name) {
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, output, 8).input('#', surround).input('$', Blocks.GLOWSTONE).pattern("###").pattern("#$#").pattern("###").group("neon_light").criterion("has_glowstone", conditionsFromItem(Blocks.GLOWSTONE)).offerTo(exporter,name);
    }
